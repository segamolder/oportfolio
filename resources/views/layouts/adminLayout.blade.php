...
<head>
    ...
    <!-- Scripts -->
    <script src="{{ mix('js/main_page.js') }}" defer></script>
                ...
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="{{ route('addPost') }}">Добавить новый</a>
                            <a class="dropdown-item" href="{{ route('postList') }}">Список постов</a>
                        </div>
                    </li>
                </ul>
